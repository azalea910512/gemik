...
" >/etc/openvpn/client-tcp-1194.ovpn
...
" >/etc/openvpn/client-tcp-9994.ovpn
...
" >/etc/openvpn/client-udp-25000.ovpn
...
" >/etc/openvpn/client-ssl-2905.ovpn
...
" >/etc/openvpn/client-ssl-9443.ovpn
